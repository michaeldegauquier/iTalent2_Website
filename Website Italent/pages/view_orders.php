                ...
                <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
                    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
                        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
                            <script src="../JQ/filterOrders.js" type="text/javascript"></script>
...
<div class="container">
    <table>
        ...
        $allOrders = OrdersDB::getAllOrders();
        foreach ($allOrders as $allOrder) {
            ?>

            <tr class="filter" id="<?php echo $allOrder->UserEmail; ?>">
                <td id="useremail"><?php echo $allOrder->UserEmail; ?></td>
                <?php
                $user2 = UserDB::getUserDataByEmail($allOrder->UserEmail);
                foreach ($user2 as $us) {
                    ?>
                    <td><?php echo $us->Firstname; ?> <?php echo $us->Lastname; ?></td>
                    <?php
                }
                ?>
                <td>
                    ...
                    foreach ($products as $product) {
                        ?>
                        Category: <?php echo $product->Category; ?> - Price: €<?php echo $product->Price; ?>
                        <?php
                    }
                    ?>
                </td>
